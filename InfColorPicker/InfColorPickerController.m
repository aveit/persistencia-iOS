...
- (id) initWithNibName: (NSString*) nibNameOrNil bundle: (NSBundle*) nibBundleOrNil
{
	...
	if (self) {
		...
		self.navigationItem.title = NSLocalizedString(@"Defina a cor",
...
- (void) presentModallyOverViewController: (UIViewController*) controller
{
  ...
  self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"OK" style:UIBarButtonItemStyleDone target:self action:@selector(done:)];
  [self.navigationItem.rightBarButtonItem setTintColor: (UIColor *)[(PRAppDelegate *)[[UIApplication sharedApplication] delegate] globalTint]];
